        ...
        <ul className="list-unstyled components">
          ...
          <li>
            <NavLink exact to="/" activeClassName="active">
              <FontAwesomeIcon icon={faVideo} /> <span>Video Management</span>
              {/* {props.showText && <span>Attendance</span>} */}
            </NavLink>
          </li>
          <li>
            <NavLink exact to="/userManagement" activeClassName="active">
              <FontAwesomeIcon icon={faUsers} /> <span>User Management</span>
            </NavLink>
          </li>
          <li>
            <NavLink exact to="/membersList" activeClassName="active">
              <FontAwesomeIcon icon={faCogs} /> <span>Content Management</span>
            </NavLink>
          </li>
